function draw_robot(r, theta, r_dot, theta_dot, f, gamma, time, total_time, r_min, r_max, theta_min, theta_max)
    ...
    %% Plot the r r_dot and f vs time and theta theta_dot and gamma vs time
    ...
    if isempty(axttdotg)
        % Second axes: theta, theta_dot, gamma
        ...
        h6 = plot(axttdotg, time_history, gamma_history, 'b', 'DisplayName','\gamma');
        hold(axttdotg, 'off');
        xlim(axttdotg, [0 total_time]); 
        title(axttdotg, '\theta, \theta\_dot, \gamma');
